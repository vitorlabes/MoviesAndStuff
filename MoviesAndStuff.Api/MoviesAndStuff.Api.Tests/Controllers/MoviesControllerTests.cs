...
//        {
//            // Arrange
//            var expectedMovies = new List<GenreListDto>
//            {
//                new GenreListDto { Id = 1, Title = "Matrix", IsWatched = true, GenreName = "Sci-Fi" },
//                new GenreListDto { Id = 2, Title = "Inception", IsWatched = false, GenreName = "Thriller" }
//            };
...
//            var movies = okResult.Value.Should().BeAssignableTo<List<GenreListDto>>().Subject;
...
//                       .ReturnsAsync(new List<GenreListDto>());
